...
badd +2 server/controller/root_controller.js
badd +1 server/qui
...
badd +1 static/index.pug
badd +1 static/quiz.css
...
set stal=2
edit server/controller/QA_controller.js
...
exe '1resize ' . ((&lines * 32 + 49) / 98)
exe 'vert 1resize ' . ((&columns * 39 + 59) / 118)
exe '2resize ' . ((&lines * 32 + 49) / 98)
exe 'vert 2resize ' . ((&columns * 39 + 59) / 118)
exe '3resize ' . ((&lines * 32 + 49) / 98)
...
exe '6resize ' . ((&lines * 30 + 49) / 98)
exe 'vert 6resize ' . ((&columns * 39 + 59) / 118)
exe '7resize ' . ((&lines * 30 + 49) / 98)
exe 'vert 7resize ' . ((&columns * 39 + 59) / 118)
exe '8resize ' . ((&lines * 30 + 49) / 98)
exe 'vert 8resize ' . ((&columns * 38 + 59) / 118)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists('server/route/root_route.js') | buffer server/route/root_route.js | else | edit server/route/root_route.js | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((15 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 103 - ((42 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((15 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
...
wincmd w
argglobal
if bufexists('static/index.pug') | buffer static/index.pug | else | edit static/index.pug | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
