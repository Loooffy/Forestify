...
silent only
cd ~/Documents/project/appworks/han-academy/static
...
badd +26 index.pug
badd +690 index.css
badd +0 ../server/model/quiz_model.js
badd +0 ../server/controller/quiz_controller.js
badd +0 ../server/route/quiz_route.js
badd +0 quiz.js
argglobal
silent! argdel *
$argadd post.js
...
exe '1resize ' . ((&lines * 18 + 48) / 96)
exe '2resize ' . ((&lines * 18 + 48) / 96)
exe '3resize ' . ((&lines * 18 + 48) / 96)
exe '4resize ' . ((&lines * 18 + 48) / 96)
exe '5resize ' . ((&lines * 18 + 48) / 96)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let s:l = 107 - ((8 * winheight(0) + 9) / 18)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((14 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
wincmd w
argglobal
if bufexists('post.js') | buffer post.js | else | edit post.js | endif
