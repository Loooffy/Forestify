...
badd +5 util/hexMapCreator.js
badd +1 static/hexMap.pug
badd +18 static/hexMap.css
badd +0 static/user.js
argglobal
silent! argdel *
...
exe '7resize ' . ((&lines * 29 + 48) / 96)
exe 'vert 7resize ' . ((&columns * 39 + 59) / 118)
exe '8resize ' . ((&lines * 29 + 48) / 96)
exe 'vert 8resize ' . ((&columns * 39 + 59) / 118)
exe '9resize ' . ((&lines * 29 + 48) / 96)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 11 - ((0 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((11 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 13 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
13
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 125 - ((22 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
